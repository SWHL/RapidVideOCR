...
class TextDirectionClassifier(object):
    def __init__(self, cls_model_path):
        ...
        self.session = PickableInferenceSession(cls_model_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, help='cls_model_dir')
    args = parser.parse_args()

    text_classifier = TextDirectionClassifier(args.model_path)

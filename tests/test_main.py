...
def test_concat_rec(img_dir):
    extractor = RapidVideOCR(is_batch_rec=True)
    extractor(img_dir, test_file_dir)
...
def test_out_only_srt():
    ...
    extractor = RapidVideOCR(is_batch_rec=True, out_format="srt")
    extractor(img_dir, test_file_dir)
...
def test_out_only_txt():
    img_dir = test_file_dir / "RGBImages"
    extractor = RapidVideOCR(is_batch_rec=True, out_format="txt")
    extractor(img_dir, test_file_dir)
